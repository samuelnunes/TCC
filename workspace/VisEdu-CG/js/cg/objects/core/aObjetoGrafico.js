...
aObjetoGrafico = function  () {
	...
	//funcao padrao para onChangeFilhos, como não existe como super()
	scope.onChangeFilhosSuper = function () {    			
		if	(scope.pai) {				
	...
	scope.add = function (objeto) {		
		...
		//ordena os filhos no array pelo tipo de encaixe
		scope.filhos.sort(function(x, y) { return(x.tipoEncaixe.seq - y.tipoEncaixe.seq); });  
