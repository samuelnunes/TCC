...
Util.math = {	
	...
	//converte uma distacia grafica pra uma distancia em pixels
	getPixelValue: function (graphicValue) { 
		return graphicValue * Util.math.precentPixelValue;		
	},

	//converte uma distancia em pixels para uma distancia grafica
	getGraphicValue: function (pixelValue) {
